...
import { getPublishedCourses, getCategories, searchCourses, getCoursesByCategory } from "../../services/courseService";
...
function CourseCatalog() {
  ...
  const filteredCourses = useMemo(() => {
    ...
    if (filterType === "MOST_VIEWED") {
      ...
      list.sort((a, b) => (a.id || 0) % 2 - (b.id || 0) % 2);
  ...
  return (
    <DashboardLayout>
      <div className="p-6 md:p-8 max-w-7xl mx-auto space-y-8">
        ...
        {statusMessage && (
          <div
            className={`p-3.5 rounded-xl text-xs font-semibold border shadow-xs animate-in fade-in duration-200 ${
          ...
          <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3">
            <div className="flex items-center gap-1.5 overflow-x-auto pb-1">
              ...
              <button
                ...
                className={`px-3.5 py-1.5 rounded-full text-xs font-bold transition-all border flex items-center gap-1 ${
